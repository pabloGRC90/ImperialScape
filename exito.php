    ...
    <div class="login-page">
        <div class="form">
            ...
            <!-- <form class="login-form" id="login-form" novalidate> -->
                ...
                <h1 class="title-form">¡Enhorabuena! <br/><br/>Habéis escapado<br/><br/></h1>

                <p>volver a la <a href="./index.html" style="text-decoration: none; color:brown">página principal</a></p>
